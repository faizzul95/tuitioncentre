...
-- Dumping database structure for tuition_community
CREATE DATABASE IF NOT EXISTS `tuition_community` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `tuition_community`;

-- Dumping structure for table tuition_community.comment
...
-- Dumping data for table tuition_community.comment: ~2 rows (approximately)
/*!40000 ALTER TABLE `comment` DISABLE KEYS */;
INSERT INTO `comment` (`com_id`, `com_desc`, `com_forum_id`, `com_user`, `com_date`) VALUES
	(33, 'Tuition Smart Maths, the schedule not so pack.', 17, 54, '2018-05-14 16:48:10'),
	(34, 'I think, Tuition Perintis Didik at Seksyen7. Last year, I already sent my children at there and they got good result in their exam.', 17, 59, '2018-06-10 12:50:00');
/*!40000 ALTER TABLE `comment` ENABLE KEYS */;

-- Dumping structure for table tuition_community.forum
...
-- Dumping data for table tuition_community.forum: ~2 rows (approximately)
/*!40000 ALTER TABLE `forum` DISABLE KEYS */;
INSERT INTO `forum` (`forum_id`, `forum_user`, `forum_title`, `forum_desc`, `forum_date`) VALUES
	(17, 53, 'Management', 'Which tuition provide better management?                    	', '2018-05-10 16:43:42'),
	(18, 57, 'Class', 'Which tuition centre that have a few students in one class (10 student in one class)                  	', '2018-05-21 18:45:56');
/*!40000 ALTER TABLE `forum` ENABLE KEYS */;

-- Dumping structure for table tuition_community.geoloc
...
-- Dumping data for table tuition_community.geoloc: ~828 rows (approximately)
...
-- Dumping structure for table tuition_community.master_subject
...
-- Dumping data for table tuition_community.master_subject: ~7 rows (approximately)
/*!40000 ALTER TABLE `master_subject` DISABLE KEYS */;
INSERT INTO `master_subject` (`subject_id`, `subject_name`) VALUES
	...
	(5, 'Mathematic'),
	(7, 'Geography');
/*!40000 ALTER TABLE `master_subject` ENABLE KEYS */;

-- Dumping structure for table tuition_community.parent
...
-- Dumping data for table tuition_community.parent: ~4 rows (approximately)
...
INSERT INTO `parent` (`parent_id`, `parent_name`, `parent_ic`, `parent_telno`, `parent_dob`, `parent_gender`, `parent_email`, `parent_img`, `parent_last_update`, `user_id`) VALUES
	...
	(14, 'Zakariah Binti Faizal', '680604-04-3021', '0176448356', '1968-06-04', 'female', 'Zakariahh@yahoo.com', 'parent-60.jpg', '2019-01-21', 60),
	(15, 'Fadlul Bin Hassan', '660507-01-6663', '0122254756', '1966-05-07', 'male', 'Fad01@yahoo.com', 'parent-62.jpg', '2019-01-21', 62);
/*!40000 ALTER TABLE `parent` ENABLE KEYS */;

-- Dumping structure for table tuition_community.payment
...
-- Dumping data for table tuition_community.payment: ~22 rows (approximately)
...
INSERT INTO `payment` (`payment_id`, `payment_status`, `payment_receipt`, `list_id`) VALUES
	...
	(52, 'PAID', '52.jpg', 58),
	(53, 'PAID', '53.jpg', 59),
	(54, 'PENDING', '54.jpg', 60),
	(55, 'UNPAID', NULL, 61),
	(56, 'PAID', '56.jpg', 62),
	(57, 'UNPAID', NULL, 63);
/*!40000 ALTER TABLE `payment` ENABLE KEYS */;

-- Dumping structure for table tuition_community.student
...
-- Dumping data for table tuition_community.student: ~17 rows (approximately)
...
INSERT INTO `student` (`student_id`, `student_name`, `student_ic`, `student_telno`, `student_dob`, `student_gender`, `student_email`, `student_img`, `student_last_update`, `user_id`) VALUES
	...
	(31, 'Nur Fazz Binti Zainudin', '040407-02-6052', '01111197668', '2004-04-07', 'female', 'Fazz@yahoo.com', 'student-31.jpg', '2019-01-21', 59),
	...
	(40, 'Siti Syasya Binti Zaki', '040820-14-3022', '0108775337', '2004-08-20', 'female', 'syasya12@yahoo.com', 'student-40.jpg', '2019-01-22', 65),
...
-- Dumping structure for table tuition_community.tuition
...
-- Dumping data for table tuition_community.tuition: ~11 rows (approximately)
...
INSERT INTO `tuition` (`tuition_id`, `tuition_name`, `tuition_telno`, `tuition_email`, `tuition_address`, `tuition_state`, `tuition_district`, `tuition_area`, `tuition_lat`, `tuition_lon`, `tuition_rating`, `tuition_img`, `user_id`) VALUES
	...
	(31, 'mawar', '0122254357', 'mawar@gmail.com', 'seksyen 7 no2', 'Selangor', 'Petaling', 'Shah Alam', 3.07141, 101.498, 0, 'tuition-31.jpg', 69),
	(32, 'mawari', '0122254357', 'mawari@gmail.com', 'no 19 jalan seksyen7', 'Selangor', 'Petaling', 'Shah Alam', 3.07152, 101.498, 0, 'user.png', 69),
	(33, 'rama', '0122254687', 'rama@gmail.com', 'seksyen7 jalan no4', 'Selangor', 'Petaling', 'Shah Alam', 3.07153, 101.498, 0, 'user.png', 70);
/*!40000 ALTER TABLE `tuition` ENABLE KEYS */;

-- Dumping structure for table tuition_community.tuition_package
...
-- Dumping data for table tuition_community.tuition_package: ~29 rows (approximately)
/*!40000 ALTER TABLE `tuition_package` DISABLE KEYS */;
INSERT INTO `tuition_package` (`package_id`, `tuition_id`, `package_name`, `package_capacity`, `package_price`) VALUES
	...
	(65, 31, 'Package AA', 20, 120),
	(66, 33, 'Package AAA', 15, 140);
/*!40000 ALTER TABLE `tuition_package` ENABLE KEYS */;

-- Dumping structure for table tuition_community.tuition_package_subject
...
-- Dumping data for table tuition_community.tuition_package_subject: ~103 rows (approximately)
/*!40000 ALTER TABLE `tuition_package_subject` DISABLE KEYS */;
INSERT INTO `tuition_package_subject` (`package_subject_id`, `subject_id`, `subject_day`, `subject_start_hour`, `subject_end_hour`, `package_id`) VALUES
	...
	(133, 3, 'Monday', '16:00:00', '17:00:00', 65),
	(134, 3, 'Tuesday', '20:00:00', '21:00:00', 66);
/*!40000 ALTER TABLE `tuition_package_subject` ENABLE KEYS */;

-- Dumping structure for table tuition_community.tuition_review
...
-- Dumping data for table tuition_community.tuition_review: ~11 rows (approximately)
/*!40000 ALTER TABLE `tuition_review` DISABLE KEYS */;
INSERT INTO `tuition_review` (`rating_id`, `package_id`, `tuition_id`, `review_star`, `review_title`, `review_comments`, `review_created`, `student_id`) VALUES
	...
	(25, 33, 19, 3, 'WOW', 'Nice teacher', '2019-01-22 10:32:53', 36),
	(26, 49, 23, 3, 'NOT BAD', 'teacher good', '2019-01-22 10:58:47', 41);
/*!40000 ALTER TABLE `tuition_review` ENABLE KEYS */;

-- Dumping structure for table tuition_community.tuition_student_list
...
-- Dumping data for table tuition_community.tuition_student_list: ~21 rows (approximately)
/*!40000 ALTER TABLE `tuition_student_list` DISABLE KEYS */;
INSERT INTO `tuition_student_list` (`list_id`, `package_id`, `student_id`, `start_date`) VALUES
	...
	(62, 65, 43, '2019-01-28'),
	(63, 53, 43, '2019-01-30');
/*!40000 ALTER TABLE `tuition_student_list` ENABLE KEYS */;

-- Dumping structure for table tuition_community.user
...
-- Dumping data for table tuition_community.user: ~25 rows (approximately)
...
INSERT INTO `user` (`user_id`, `user_username`, `user_type`, `user_password`) VALUES
	...
	(66, 'loqman', 'student', 'loqman@25'),
	(67, 'Sufian', 'student', 'Sufian@25'),
	(68, 'lina', 'student', 'lina@25'),
	(69, 'ty', 'tuition', 'mawar@25'),
	(70, 'mariah', 'tuition', 'rama@25');

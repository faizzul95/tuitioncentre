...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title> Admin | Tuition List</title>
        ...
        <script type="text/javascript">
            function delete_data(id)
            {
                ...
                {
                    window.location = "controller.php?userDel="+id;
                }
            }
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">Tuition List</span>
                                        </div>
                                        <!-- <div class="tools"> </div> -->
                                    </div>
                                    <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <tbody>
                                             <?php
                                                  $result = $myConnection->query("SELECT * FROM `tuition`") or die (mysqli_error($myConnection));
                                                ...
                                                if($result!=FALSE)
                                                {
                                                    ...
                                                    while($row = $result->fetch_assoc())
                                                    {
                                                        ...
                                                        $district = $row['tuition_district'];
                                                        $area = $row['tuition_area'];

                                                        $rating = $row['tuition_rating'];
                                                        $image = $row['tuition_img'];
                                                        ?>
                                                            <tr>
                                                                ...
                                                                <td><center><?php echo $area; ?></center></td>

...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title> Admin | Feedback (Parent)</title>
                    ...
                    <div class="page-content">
                        ...
                        <div class="page-bar">
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <span>Feedback List (Parent)</span>
                                </li>
                            </ul>
                        </div>
                        <!-- END PAGE BAR -->
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title">
                                        <div class="caption font-dark">
                                            ...
                                            <span class="caption-subject bold uppercase">Feedback List (Parent)</span>
                                        </div>
                                        <!-- <div class="tools"> </div> -->
                                    </div>
                                     <div class="portlet-body">
                                        <table class="table table-striped table-bordered table-hover" id="sample_1">
                                            ...
                                            <tbody>
                                             <?php
                                                  $result = $myConnection->query("SELECT * FROM `feedback` WHERE user_type = 'parent' ORDER BY `feedback_status` DESC") or die (mysqli_error($myConnection));

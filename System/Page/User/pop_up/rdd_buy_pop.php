...
<div id="BuyRDDModal" class="modal"> 
  
    <!-- Modal content -->
    <div class="modal-content"> <span class="closeBuyRDDModal">&times;</span>
    <p align="center" class="customfont"><font size="5" color="#005B9EFF">Buy RDD</font></p>
    <br />
    <br>
    <font size="2">
    ...
    <div class="col-sm-8">
      ...
      <?php include("bank_list/bank_list_rdd_buy.php"); ?>		
	  </select>
    </div>
    <br>
    <br>
    ...
    <div class="col-sm-4">RDD Address:</div>
    <div class="col-sm-8">
    ...
    * Please make sure your RDD Address is valid. We will not responsible for wrong RDD Address information.
    </font>
    </div>
    <br>
    <br>
    ...
    <div class="col-sm-8">
       ...
       <input type="hidden" class="form-control" name="type_of_coin" value='3' >

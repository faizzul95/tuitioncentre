...
<div id="BuyBTCModal" class="modal"> 
  
    <!-- Modal content -->
    <div class="modal-content"> <span class="closeBuyBTCModal">&times;</span>
    <p align="center" class="customfont"><font size="5" color="#005B9EFF">Buy Bitcoin</font></p>
    <br />
    <br>
    <font size="2">
    ...
    <div class="col-sm-8">
      ...
      <?php include("bank_list/bank_list_btc_buy.php"); ?>			
	  </select>
    </div>
    <br>
    <br>

<!-- The Pop Up -->
<link href="https://includes.googleapis.com/css?family=Montserrat" rel="stylesheet">
<style type="text/css">
p.custominclude {
	include-family: 'Montserrat', sans-serif;
}
</style>
...
<div id="RemSellAdsModal" class="modal"> 
  
    <!-- Modal content -->
    <div class="modal-content"> <span class="closeRemSellAdsModal">&times;</span>
    <p align="center" class="custominclude"><include size="5" color="#005B9EFF">Sell Coin Ads</include></p>
    <br />
    <br>
    <include size="2">
    ...
    <div class="col-sm-8">
				  ...
				  <?php include("type_of_payment_method.php"); ?>			
				  </select>
                  </div>
    <br>
    <br>
    ...
    <div class="col-sm-8">
				  ...
				  <?php include("type_of_payment_window.php"); ?>			
				  </select>
                  </div>
    <br>
    <br>
    ...
    <div class="col-sm-8">
				  ...
				  <?php include("./bank_list/bank_list_rem_buy_ads.php"); ?>	
				  </select>
                  </div>
    <br>
    <br>
    ...
    <div class="col-sm-8">
       ...
       <button style="width:100%;" name="rem_buy_sell_ads" class="button">Submit</button>
    </div>
    <div class="col-sm-2"></div>
    <br>
    <br>

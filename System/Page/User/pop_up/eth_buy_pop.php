...
<div id="BuyETHModal" class="modal"> 
  
    <!-- Modal content -->
    <div class="modal-content"> <span class="closeBuyETHModal">&times;</span>
    <p align="center" class="customfont"><font size="5" color="#005B9EFF">Buy Ethereum</font></p>
    <br />
    <br>
    <font size="2">
    ...
    <div class="col-sm-8">
      ...
      <?php include("bank_list/bank_list_eth_buy.php"); ?>				
	  </select>
    </div>
    <br>
    <br>

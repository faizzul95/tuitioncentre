...
<div id="BuyPNDModal" class="modal"> 
  
    <!-- Modal content -->
    <div class="modal-content"> <span class="closeBuyPNDModal">&times;</span>
    <p align="center" class="customfont"><font size="5" color="#005B9EFF">Buy Panda</font></p>
    <br />
    <br>
    <font size="2">
    ...
    <div class="col-sm-8">
      ...
      <?php include("bank_list/bank_list_pnd_buy.php"); ?>		
	  </select>
    </div>
    <br>
    <br>
    ...
    <div class="col-sm-4">PND Address:</div>
    <div class="col-sm-8">
    ...
    * Please make sure your PND Address is valid. We will not responsible for wrong PND Address information.
    </font>
    </div>
    <br>
    <br>
    ...
    <div class="col-sm-8">
       ...
       <input type="hidden" class="form-control" name="type_of_coin" value='4' >

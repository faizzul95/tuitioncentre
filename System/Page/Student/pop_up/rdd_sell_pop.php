...
<div id="SellRDDModal" class="modal"> 
  
  <!-- Modal content -->
  
  <div class="modal-content"> <span class="closeSellRDDModal">&times;</span>
    <p align="center" class="customfont"><font size="5" color="#005B9EFF">Sell RDD</font></p>
    <br />
    <br>
    <font size="2">
    ...
    <div class="col-sm-8">
      ...
      <?php include("bank_list/bank_list_rdd_sell.php"); ?>				
	  </select>
    </div>
    <br>
    <br>

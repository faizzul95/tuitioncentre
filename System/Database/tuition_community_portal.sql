...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 14, 2018 at 01:40 PM
...
CREATE TABLE `list_package_student` (
  `id` int(11) NOT NULL,
...
INSERT INTO `list_package_student` (`id`, `package_refer_code`, `student_ic`, `status`, `created_date`) VALUES
(3, 'SQ52J1ZQ', '', 1, '2018-10-07'),
(4, 'SQ52J1ZQ', '', 1, '2018-10-07'),
(5, 'SQ52J1ZQ', '', 1, '2018-10-07'),
(6, 'SQ52J1ZQ', '2432443434', 1, '2018-10-07'),
(7, 'KX2DmOxg', '', 1, '2018-10-14');
...
(1, 'CkwTLWBe', 'SQ52J1ZQ', '1111', '111', '11', 3, 11, 1, '2018-10-07', 1, '0000-00-00', 0, '0000-00-00', 0),
(2, 'CkwTLWBe', 'KX2DmOxg', 'Math Package', 'Column headingColumn headingColumn headingColumn headingColumn heading\r\n\r\nColumn headingColumn headingColumn headingColumn heading\r\n\r\nColumn headingColumn headingColumn headingColumn heading', '500', 1, 50, 1, '2018-10-07', 1, '0000-00-00', 0, '0000-00-00', 0);
...
INSERT INTO `user` (`id`, `level`, `refer_code`, `ic_no`, `username`, `user_type`, `password`, `name`, `phone_number`, `address`, `isuser`, `status`, `created_date`, `created_by`, `updated_date`, `updated_by`, `blocked_date`, `blocked_by`, `unblocked_date`, `unblocked_by`, `deleted_date`, `deleted_by`) VALUES
(1, 1, '', '', 'admin@gmail.com', '', 'admin@gmail.com', 'admin@gmail.com', '', '', 0, 1, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0),
(8, 0, '', '', 'hardik', 'user', '123', '', '', '', 1, 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0),
(13, 2, 'ffD7ilDl', '', 'pakarbinawebsite@gmail.com', 'user', '123', 'Mohd Ashraf', '01313133123', '', 0, 1, '2018-09-28', 13, '2018-09-30', 13, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0),
(14, 3, '', '930505095043', 'website@gmail.com', 'user', '123', 'Mohd Ashraf', '0112321323', '', 0, 1, '2018-10-07', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0),
(15, 3, '', '2432443434', 'fefsdf@gmail.com', 'user', '123', 'fdsfd', '33545345', 'No.19,Jalan Indah, 2/10,\r\nTaman Puchong Indah', 0, 1, '2018-10-07', 0, '2018-10-07', 15, '0000-00-00', 0, '0000-00-00', 0, '0000-00-00', 0);
...
--
-- Indexes for table `list_package_student`
--
ALTER TABLE `list_package_student`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tuition_list`
--
ALTER TABLE `tuition_list`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tuition_package`
--
ALTER TABLE `tuition_package`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `list_package_student`
--
ALTER TABLE `list_package_student`
...
--
-- AUTO_INCREMENT for table `tuition_list`
--
ALTER TABLE `tuition_list`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `tuition_package`
--
ALTER TABLE `tuition_package`
